...
const AllEvaluator_Register = () => {
  ...
  const onSubmit: SubmitHandler<any> = async (data) => {
    try {
      axios
        .post(
          `${VITE_DATABASE_HOST}/penilai-dalaman/daftar-penilai/daftar`,
          data
        )
        .then((response) => {
...
export default AllEvaluator_Register;
